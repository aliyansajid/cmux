...
baked at `/home/cmux/.cmux/bin/cmux-tui` from the files.cmux.com artifacts manifest pin
...
and the bake installs the pinned static-musl build at `/home/cmux/.cmux/bin/cmux-tui` with
