...
struct CloudTreeNodeActions {
    ...
    static func bound(
        ...
        let workspaceHost = SurfaceCatalog.NewWorkspaceHost.appOptimistic(preferredTabManager: preferredTabManager)
    ...
    static func createWorkspaceAndOpenLocally(
        ...
        let opened = try await catalog.projectGroupAsNewLocalWorkspace(
            ...
            focus: focus,
            host: SurfaceCatalog.NewWorkspaceHost.appOptimistic(preferredTabManager: preferredTabManager)
        )
        catalog.bindCloudWorkspace(
            localWorkspaceID: opened.workspaceID,
            machine: machine,
