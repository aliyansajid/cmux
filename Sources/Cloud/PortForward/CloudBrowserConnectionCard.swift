    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                if let onOpenProxy, message != nil {
                    Button(String(localized: "cloudTree.pane.openProxy", defaultValue: "Open through cmux.sh instead"), action: onOpenProxy)
                        .buttonStyle(.bordered)
                        .accessibilityIdentifier("CloudBrowserProxyButton")
                }
                if message == nil {
